...
// -*- C++ -*-
// File: OneService.cc
// Version: $Id: OneServiceTest.cc,v 1.4 1998/07/30 20:35:36 talmage Exp $
//
// Purpose: main() for the instantiation of OneService.  See
// OneService.cc
...
int main(int argc, char **argv)
{
  ...
  DiagLevel("OneService", DIAG_INFO);
  ...
  //
    ...
    if (port > 0) {
      ...
      smanager = new OneService("OneService", host_nic, lifetime);
