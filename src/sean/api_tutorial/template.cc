...
#ifndef LINT
static char const _template_cc_rcsid_[] =
"$Id: template.cc,v 1.4 1998/09/28 12:31:44 bilal Exp $";
#endif
...
public:
  ...
  simple_controller(void) {
  }

  virtual ~simple_controller(void) {
  }
...
int main(int argc, char** argv) {
  ...
  simple_controller my_simple_controller;
  sig.Associate_Controller(my_simple_controller);
