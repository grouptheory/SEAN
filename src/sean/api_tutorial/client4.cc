...
"$Id: client4.cc,v 1.4 1998/09/28 12:31:44 bilal Exp $";
#endif
...
// callback for 10 seconds from now, upon which it will cancel the
// 10-second perodic callback and send some data on the connection.]
//
// NEW: It registers a periodic callback for 20 seconds from now, upon
// which it will tear down the call but not exit.
// **************************************************************************
