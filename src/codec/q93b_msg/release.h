...
#ifndef LINT
static char const _release_h_rcsid_[] =
"$Id: release.h,v 1.13 1998/12/15 15:23:50 mountcas Exp $";
#endif
...
public:
  ...
  q93b_release_message(q93b_release_message & him);
  q93b_release_message(InfoElem** ie_array, u_long call_ref_value, u_int flag);
  q93b_release_message(InfoElem** ie_array, u_long call_ref_value,
		       u_int flag, Buffer* buf);

  q93b_release_message(const u_char * buf, int len);

  virtual ~q93b_release_message( ) { };
