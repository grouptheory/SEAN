...
#ifndef LINT
static char const _restart_h_rcsid_[] =
"$Id: restart.h,v 1.9 1998/12/15 15:24:30 mountcas Exp $";
#endif
...
public:
  ...
  q93b_restart_message(q93b_restart_message & him);
  q93b_restart_message(InfoElem ** ie_array, u_long call_ref_value, u_int flag);
  q93b_restart_message(InfoElem ** ie_array, u_long call_ref_value,
		       u_int flag, Buffer* buf);

  q93b_restart_message(const u_char* buf, int len);
