...
// future upgrades.
#ifndef LINT
static char const _Optimizer_cc_rcsid_[] =
"$Id: Optimizer.cc,v 1.1 1999/01/21 14:54:39 mountcas Exp $";
#endif
#include <common/cprototypes.h>

#include "Optimizer.h"

double Optimizer::maxCos = cos( M_PI / 8 );

Optimizer::Optimizer(void) 
  : resetFlag(true), numberOfIterations(0), time(0) { }

Optimizer::~Optimizer() { }

void Optimizer::reset(void) { resetFlag = true; }
