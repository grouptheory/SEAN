...
#ifndef LINT
static char const _Model_h_rcsid_[] =
"$Id: Model.h,v 1.2 1999/02/10 21:13:02 marsh Exp $";
#endif

class Graph;

// This abstract class encapsulates the physically-based model
// used to evaluate a drawing.  Its concrete subclasses must
// implement a method to compute the gradient of the objective
...
public:
  ...
  virtual double * computeGradient(Graph & g, double * gradient, int & gLength) = 0;

  // SPRING LAWS
  static const int LOG = 0, LINEAR = 1, QUADRATIC = 2;

  // REPULSION LAWS
  static const int INVERSE = 3, INVERSESQUARE = 4, NONE = 5;
};
