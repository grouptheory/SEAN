...
#ifndef LINT
static char const _BinaryTree_h_rcsid_[] =
"$Id: BinaryTree.h,v 1.1 1999/01/21 14:54:39 mountcas Exp $";
#endif

#include "Graph.h"

// The class is used to generate complete binary tree graphs
// of height h.  If the dir parameter is false, the tree will
// be undirected; if it is true, the tree will be a directed.
class BinaryTree : public Graph {
public:

  BinaryTree(int h, bool dir);
  virtual ~BinaryTree();
};
