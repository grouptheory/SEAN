...
// future upgrades.
#ifndef __SQUAREMESH_H__
#define __SQUAREMESH_H__

#ifndef LINT
static char const _SquareMesh_h_rcsid_[] =
"$Id: SquareMesh.h,v 1.1 1999/01/21 14:54:39 mountcas Exp $";
#endif

#include "Graph.h"

// The class is used to generate square n by n mesh graphs.
// If the dir parameter is false, the mesh will be undirected;
// if it is true, the mesh will be a directed.
class SquareMesh : public Graph {
public:

  SquareMesh(int n, bool dir);
  virtual ~SquareMesh();
};
