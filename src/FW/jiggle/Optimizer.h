...
#ifndef LINT
static char const _Optimizer_h_rcsid_[] =
"$Id: Optimizer.h,v 1.2 1999/02/10 21:14:35 marsh Exp $";
#endif
...
// This abstract class encapsulates an iterative optimization procedure.
// Its concrete subclasses must implement a method that attempts to
// improve a graph with respect to a given model.
class Optimizer {
public:
  ...
  virtual double improve(Graph & g, Model & m) = 0;
...
protected:
  ...
  static double maxCos;  // g++ doesn't like function calls in const decl
};
